...
class Config:
    ...
    MAIL_DEFAULT_SENDER = os.getenv('MAIL_DEFAULT_SENDER', 'cutting_fb@murata.com')
    ...
    # Excel history file paths
    HISTORY_A1_PATH = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'history_A1.xlsx')
    HISTORY_GHM_PATH = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'history_GHM.xlsx')
    HISTORY_KEM_PATH = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'history_KEM.xlsx')
