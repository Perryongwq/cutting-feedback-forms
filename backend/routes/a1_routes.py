    ...
    try:
        ...
        if 'data' in request.form:
            ...
            form_data = {
                ...
                'shifting_direction_a': parse_json_or_list('shifting_direction_a'),
                'shifting_direction_b': parse_json_or_list('shifting_direction_b'),
                'shifting_direction_c': parse_json_or_list('shifting_direction_c'),
                'shifting_direction_d': parse_json_or_list('shifting_direction_d'),
